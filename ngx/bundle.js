...
var FirebaseCrashlytics = /** @class */ (function (_super) {
    ...
    FirebaseCrashlytics.plugin = "cordova-plugin-firebase-crashlytics-fixed";
    FirebaseCrashlytics.pluginRef = "FirebaseCrashlytics";
    FirebaseCrashlytics.repo = "https://github.com/rapinto/cordova-plugin-firebase-crashlytics";
    FirebaseCrashlytics.install = "ionic cordova plugin add cordova-plugin-firebase-crashlytics-fixed --variable ANDROID_FIREBASE_CORE_VERSION=16.0.0";
